...
With this Reddit-like application, users can login, create posts, edit posts, leave comments, and up or down vote either. The app was developed using Ruby on Rails, ERB templates, ActiveRecord, and SQLite in a walk-through tutorial.
